    ...
    <div>
        ...
        <table style="width:100%">
            <tr>
                ...
                <td style="width:43%">
                    {{ $dados->PrestadorServico->Endereco->Endereco . ', ' . $dados->PrestadorServico->Endereco->Numero . ', ' . $dados->PrestadorServico->Endereco->Bairro . ' CEP : ' . $dados->PrestadorServico->Endereco->Cep }}
                </td>
            </tr>
        </table>
        ...
        <table style="width:100%">
            <tr>
                ...
                <td style="width:50%">
                    {{ $dados->TomadorServico->Endereco->Endereco . ', ' . $dados->TomadorServico->Endereco->Numero . ', ' . $dados->TomadorServico->Endereco->Bairro . ' CEP : ' . $dados->TomadorServico->Endereco->Cep }}
                </td>
            </tr>
        </table>
        ...
        <table style="width:100%">
            <tr>
                ...
                <td style="width:8%">{{ $dados->Servico->ValorPis }}</td>
                <td style="width:8%">COFINS</td>
                <td style="width:8%">{{ $dados->Servico->ValorCofins }}</td>
                <td style="width:8%">IR(R$)</td>
                <td style="width:8%">{{ $dados->Servico->ValorIr }}</td>
                <td style="width:8%">INSS(R$)</td>
                <td style="width:8%">{{ $dados->Servico->ValorIss }}</td>
                <td style="width:8%">CSLL(R$)</td>
                <td style="width:8%">{{ $dados->Servico->ValorCsll }}</td>
            </tr>
        </table>
